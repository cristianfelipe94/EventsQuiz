...
(function () { // eslint-disable-line
  ...
  xmlhttp.addEventListener('load', function() { // eslint-disable-line
    ...
    function loadEvents() {
      ...
      $currentMainEvent.attr('class', 'event__state__active');
    }
    ...
    function createMainEvent(element, elementImgIndex) {
      ...
      const $listMainImg = $('<img>')
        ...
        .attr('class', 'event__background__img')
    ...
    function createBucketElement(endEventDateFormatedKey, eventNameKey, eventLocationKey, eventTicketsURLKey) {
      ...
      $newListItem.click(function() { // eslint-disable-line
        ...
        $('.event__background__img').remove();

        $('#js-bucket-event-list li').attr('class', 'event__state__deactive');

        $newListItem.attr('class', 'event__state__active');
    ...
    function slider() {
      ...
      function slideLeft() {
        ...
        $imgArrayIndex.addClass('event__state__active');
